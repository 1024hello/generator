...
public class MyBatisPlusGenerate {
     ...
     * 作者
     */
    private static final String AUTHOR = "hezhanfeng";
     ...
     * JDBC 连接地址
     */
    private static final String JDBC_URL = "jdbc:mysql://42.192.230.53:3306/ry-vue?serverTimezone=Asia/Shanghai&useLegacyDatetimeCode=false&nullNamePatternMatchesAll=true&zeroDateTimeBehavior=CONVERT_TO_NULL&tinyInt1isBit=false&autoReconnect=true&useSSL=false&pinGlobalTxToPhysicalConnection=true";
     ...
     * 数据库密码
     */
    private static final String JDBC_PASSWORD = "yanan1024info.com";

    /**
     * 包配置 - 父级目录
     */
    private static final String PACKAGE_PARENT = "com.yilers.wxapp";
     ...
     * 要生成的表，用 `,` 分割
     */
    private static final String TABLES = "wx_user_info";

    /**
     * 通用包路径
     */
    private static final String PACKAGE_BASE = "com.yles.auth.commons.base";
    ...
    private static PackageConfig packageConfig() {
        ...
        // 设置模块的名字，比如 core，生成效果为 com.onlinedu.core
